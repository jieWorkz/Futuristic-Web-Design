<section class="text-center section-xxl fullwidth-page fullwidth-page_mod-1 bg-accent-gradient particles-js-wrap context-dark">
    ...
    <div class="container">
        <img src="{{ asset('/images/zoho-one.png') }}" width="500" height="100" style="margin: bottom 50px;">
        <h4 class="mt-0 text-width-2 block-centered">Meet the Operating System for Businesses</h4>
        <p style="font-size: 20px">Our sophisticated approach to business software gives you one integrated and customizable system to work smarter and grow faster.</p>
